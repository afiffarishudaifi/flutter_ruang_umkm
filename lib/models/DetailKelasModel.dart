class Detail {
  ...
  Detail(
      ...
      this.tag,
      this.slug,
      this.emailFasilitator,
      this.jenis,
      this.extraFasilitator,
      this.extraMateri,
      this.extraTopik,
      this.extraPeringkat,
      this.arrIdUserPeserta});
  ...
  Detail.fromJson(Map<String, dynamic> json) {
    ...
    jenis = json['jenis'];
    extraFasilitator = json['extraFasilitator'] != null
        ? new ExtraFasilitator.fromJson(json['extraFasilitator'])
        : null;
    if (json['extraMateri'] != null) {
      extraMateri = <ExtraMateri>[];
      json['extraMateri'].forEach((v) {
        extraMateri!.add(new ExtraMateri.fromJson(v));
      });
    }
    if (json['extraPeringkat'] != null) {
      extraPeringkat = <ExtraPeringkat>[];
      json['extraPeringkat'].forEach((v) {
        extraPeringkat!.add(new ExtraPeringkat.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.extraPeringkat != null) {
      data['extraPeringkat'] =
          this.extraPeringkat!.map((v) => v.toJson()).toList();
    }
